...
<article class="page-container">
	<form action="<%=basePath%>/a/sysORole/update.do" method="post" class="form form-horizontal">
	   ...
	   <input type="hidden" value="${nowDate}" name="updateDate" id="updateDate">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${sysORole.name }" placeholder="" id="name" name="name" required="required">
			</div>
		</div>
