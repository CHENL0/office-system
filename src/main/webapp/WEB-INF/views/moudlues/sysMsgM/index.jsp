		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A">用户名 <i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
		...
		<dl id="menu-product">
			...
			<dd>
                ...
                <!--
                    ...
                    -->
                    <li><a data-href="product-brand.html" data-title="请假信息管理" href="javascript:void(0)">请假信息管理</a></li>
                     <li><a data-href="product-brand.html" data-title="加班信息管理" href="javascript:void(0)">加班信息管理</a></li>
		...
		<dl id="menu-comments">
			...
			<dd>
                ...
                <!--
                    ...
                    -->
                    <li><a data-href="feedback-list.html" data-title="工作目标信息" href="javascript:void(0)">工作目标信息</a></li>
                    <li><a data-href="feedback-list.html" data-title="工作情况汇报" href="javascript:void(0)">工作情况汇报</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-member">
