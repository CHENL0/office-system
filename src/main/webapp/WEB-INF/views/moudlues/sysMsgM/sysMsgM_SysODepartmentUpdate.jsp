...
<article class="page-container">
	<form action="<%=basePath%>/a/sysODepartment/update.do" method="post" class="form form-horizontal">
	   ...
	   <input type="hidden" value="${nowDate}" name="updateDate" id="updateDate">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${sysODepartment.name }" placeholder="" id="name" name="name" required="required">
			</div>
		</div>
		<div class="row cl">
