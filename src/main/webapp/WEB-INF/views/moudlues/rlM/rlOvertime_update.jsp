...
<article class="page-container">
    <form action="<%=basePath%>RlOvertime/updateOvertimeStatus.do?" method="post" class="form form-horizontal"   id="form-notice-add">
        ...
        <%--<input type="hidden" value="${nowDate}" name="updateDate" id="updateDate">--%>
            <input type="hidden" value="${param.overtimeId}" name="overtimeId" id="overtimeId" >
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>类型：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="overtimeStatus" id="overtimeStatus" required="required">
