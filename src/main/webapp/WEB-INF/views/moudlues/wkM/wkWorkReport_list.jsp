...
<div class="page-container">
	<div class="text-c">
		<form action="<%=basePath%>/WkWorkReport/wkWorkReportPage.do?createBy.id=${param.currentUserId}" method="post">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<c:forEach items="${wkWorkReportList }" var="wkWorkReportList">
				<%--<c:if test="${wkWorkReportList.delFlag != '1'}">--%>
					<tr class="text-c" >
    ...
    function member_del(obj,id){
        ...
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                data:{id:id},
                type: 'POST',
                url: '<%=basePath%>/WkWorkReport/deleteWkWorkTargetForUser.do',
                dataType: 'json',
                success: function(data){
