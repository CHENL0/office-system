...
<article class="page-container">
    <form action="<%=basePath%>WkWorkTarget/submitWkWorkTarget.do?" method="post" class="form form-horizontal"   id="form-notice-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>工作目标内容：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea  cols="" rows="" class="textarea" required="required" placeholder="说点什么...最少输入10个字符" onKeyUp="$.Huitextarealength(this,100)"id="text" name="text"></textarea>
